...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #create a game instance to store game statistics, and game statistics
    ...
    def run_game(self):
     ...
     #function to check for events like keypresses and mouse events.       
    ...
    #separate function for keydown events to keep the code organized and readable.               
    ...
    #separate function for keyup events to keep the code organized and readable.
    ...
    def _update_bullets(self):
        ...
        self.check_bullet_alien_colliosion()
                
                
    def check_bullet_alien_colliosion(self):
        ...
        if not self.aliens:
            #destroy the existing bullets and create create new fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        #spacing between the alien is one width length and one alien height
        #make an alien.
        alien = Alien(self)
    ...
    def _update_aliens(self):
        """Check if the alien is at the edge and change its position"""
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                #Treat it same as if the ship got hit
                self._ship_hit()
                break
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any alien have reached edge."""
        for alien in self.aliens.sprites():
